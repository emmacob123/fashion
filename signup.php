                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        ...
                                        <?php if (isset($_POST['button'])) : ?> <div class="alert alert-danger">
                                                <?php if ($result) {
                                                    echo $result;
                                                } ?>
                                            </div>
                                ...
                                <div class="input-group">
                                    <input name="phone" type="tel" class="form-control" placeholder="Your Phone number">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button name="button" type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Sign up now.</button>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
                                    <div class="col-sm-5 col-xs-12 forgot-phone text-left">
                                        <a href="login.php" class="text-left f-w-600 text-inverse"> login?</a>
                                    </div>
                                </div>
                                <div class="row">
                                    </br>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Thank you and enjoy our fashion design.</p>
                                        <p class="text-inverse text-left"><b>E-fashion berry Team</b></p>
                                    </div>
                                    <div class="col-md-2">
