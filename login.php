...
<body class="fix-menu">
    <?php require_once "includes/admin_login.php"; ?>
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        ...
                                        <?php if (isset($_POST['btn'])) : ?> <div class="alert alert-danger">
                                                <?php if ($result) {
                                                    echo $result;
                                                } ?>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-5 col-xs-12 forgot-phone text-left">
                                        <a href="signup.php" class="text-left f-w-600 text-inverse"> Signup?</a>
                                    </div>
                                </div>
                                <div class="row">
                                    </br>
